...
def create_label_and_entry(parent, text, row, column):
    label = tk.Label(parent, text=text, font=font_label, bg='#44475a', fg='#50fa7b')
...
title_label = tk.Label(window, text='Calculadora IMC', font=('Arial', 18, 'bold'), bg='#44475a', fg='#50fa7b')
...
calculate_button = tk.Button(button_frame, text='Calcular', font=font_button, command=calculate_imc, bg='#50fa7b', fg='black', relief='solid', bd=0, padx=10, pady=5)
calculate_button.pack(pady=10)

result_label = tk.Label(window, text='IMC: ', font=font_label, bg='#44475a', fg='#50fa7b')
result_label.pack()
